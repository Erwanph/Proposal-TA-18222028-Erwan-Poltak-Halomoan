...
\begin{center}
    ...
    {\Large\bfseries PENGEMBANGAN SISTEM PREDIKSI BI-RATE BERBASIS EXPLAINABLE ARTIFICIAL INTELLIGENCE (XAI) DAN LARGE LANGUAGE MODEL (LLM) MENGGUNAKAN INDIKATOR MAKROEKONOMI}\\
     \vspace{4cm}
